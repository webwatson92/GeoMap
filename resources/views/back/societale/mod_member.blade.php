                                  ...
                                  <div class="row">
                                     ...
                                     <div class="col-sm-4">
                                        <div class="form-group">
                                          ...
                                          <input type="text" name="prenom" class="form-control" id="prenom" placeholder="Entrer un prénom" value="{{old('prenom') ?? $members->prenom}}"  required autofocus>
                                          @error('prenom')
                                              <div class="invalid-feedback">{{ $message }}</div>
                                          @enderror
                                        </div>
                                     ...
                                     <div class="col-sm-4">
                                          ...
                                          <input type="date" name="date_naissance" class="form-control" id="date_naissance" placeholder="Entrer le nom de votre coopérative" value="{{old('date_naissance') ?? $members->date_naissance}}"   autofocus>
                                  ...
                                  <div class="row">
                                     ...
                                     <div class="col-sm-4">
                                          <div class="form-group">
                                                ...
                                                <input type="text" name="numero_p" class="form-control" id="numero_p" placeholder="Numéro de la pièce"  value="{{old('numero_p') ?? $members->numero_p}}"  autofocus>
                                                @error('numero_p')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                          </div>
                                     ...
                                     <div class="col-sm-4">
                                          <div class="form-group">
                                            ...
                                            <input type="text" name="tel" class="form-control" id="tel" placeholder="Téléphone"  value="{{old('tel') ?? $members->tel}}"  autofocus>
                                            @error('tel')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                          </div>
                                  ...
                                  <div class="row">
                                     ...
                                     <div class="col-sm-4">
                                          <div class="form-group">
                                            ...
                                            <input type="text" name="tel_interlocuteur" class="form-control" id="tel_interlocuteur" placeholder="Téléphone" value="{{old('tel_interlocuteur') ?? $members->tel_interlocuteur}}" autofocus>
