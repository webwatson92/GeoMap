     ...
     <div class="container">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="row new-caisse" style="margin:3vh">
                                <div class="col-sm-4">
                                  <a href="{{route('magso_add_member') }}" class="btn btn-primary">Créer un membre</a>
                                </div>
                                <div class="col-sm-8">
                                         ...
                                         @foreach($members as $user)
                                            <tr>
                                                  ...
                                                  <td>
                                                      ...
                                                      <a onclick="return confirm('Etes-vous sûr de vouloir supprimer ?')" href="{{route('users.delete', $user)}}"><i style="color:red" class="fas fa-trash-alt"></i></a>
                                                  </td>   
                                            </tr>      
                                        @endforeach  
                                    </tbody>
