...
@section('content')
	 ...
	 <div class="container-fluid">
             ...
             <form method="POST" autocomplete="on" action="{{ route('magso_add_typep.store') }}">
              @csrf
                <div>
                                <div class="card card-primary">
                                   <div class="card-header text-center">
                                        <h3 class="" style="text-align: center;">Formulaire d'ajout des types de pièce</h3>
                                    </div>
                                </div>
                              </div>
                ...
                <div class="card-body">
                   <div class="form-group">
                    ...
                    <input type="text" name="nom" class="form-control" id="nom" placeholder="CNI | Permis ..." :value="old('nom')"  autofocus>
                  </div>
                <!-- /.card-body -->
                <div class="row">
